...
class WebsiteHrRecruitment(Home):
    ...
    def _get_applicant_char_fields(self):
        ...
        return ['middlename', 'lastname', 'gender', 'place_of_birth',
                ...
                'street_ca', 'street2_ca', 'city_ca', 'zip_ca',
                'identification_id', 'provident_fund_id',
                ]
    ...
    def jobs_thankyou(self, **kwargs):
        ...
        vals['street_ca'] = kwargs.get('street_ca')
        vals['street2_ca'] = kwargs.get('street2_ca')
        vals['city_ca'] = kwargs.get('city_ca')
        vals['zip_ca'] = kwargs.get('zip_ca')
        vals['state_id_ca'] = kwargs.get('state_id_ca')
        vals['identification_id'] = kwargs.get('identification_id')
        vals['provident_fund_id'] = kwargs.get('provident_fund_id')
