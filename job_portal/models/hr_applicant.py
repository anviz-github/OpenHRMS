...
class HrApplicant(models.Model):
    ...
    #   Contact Address
    street_ca = fields.Char('Street')
    street2_ca = fields.Char('Street2')
    city_ca = fields.Char('City')
    zip_ca = fields.Char('Zip')
    state_id_ca = fields.Many2one('res.country.state', string="State")
